...
type IconName =
  | 'trophy' | 'grid' | 'pulse' | 'user' | 'users' | 'plus' | 'bolt'
...
export function Icon({ name, size = 22, color = 'currentColor', stroke = 2 }: Props) {
  ...
  switch (name) {
    ...
    case 'users':
      return (<svg {...c}><circle cx="9" cy="8" r="3.2" /><path d="M3.5 20c0-3.4 2.6-5.2 5.5-5.2s5.5 1.8 5.5 5.2" /><path d="M16.2 5.3a3.2 3.2 0 010 5.7" /><path d="M17.6 14.6c2.3.5 3.9 2.3 3.9 5.1" /></svg>);
    case 'chat':
      return (<svg {...c}><path d="M21 11.5a8 8 0 01-11.6 7.1L4 20l1.4-5.3A8 8 0 1121 11.5z" /></svg>);
    case 'plus':
